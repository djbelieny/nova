...
export async function refreshTokenIfNeeded(
  ...
  try {
    ...
    // Other providers: refresh not supported — return false so callers can surface the issue
    console.warn(`[service-integrations] Token refresh not supported for ${provider} — token may be expired.`);
    return false;
