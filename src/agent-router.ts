...
const AGENT_MCP_SERVERS: Record<string, string[]> = {
  helios: ["gohighlevel", "exa", "tavily", "browserbase", "gws", "square"],
  pixel: ["gohighlevel", "exa", "tavily", "browserbase", "gws", "notion", "firecrawl", "stitch", "magic"],
  kai: ["notion", "exa", "tavily", "browserbase", "gws", "firecrawl"],
  orion: ["gws", "gohighlevel", "exa", "tavily", "browserbase", "notion"],
  morpheus: ["exa", "tavily", "browserbase", "gws", "notion"],
  architect: ["exa", "tavily", "browserbase", "cloudflare", "notion", "gws", "playwright", "firecrawl", "stitch", "magic"],
  athena: ["exa", "tavily", "browserbase", "notion", "gws", "square", "gohighlevel"],
  cyra: ["exa", "tavily", "browserbase", "gws", "cloudflare", "notion", "playwright", "firecrawl"],
  magnus: ["exa", "tavily", "browserbase", "notion", "gws", "cloudflare", "playwright", "firecrawl"],
  digit: ["square", "gohighlevel", "gws", "notion", "exa", "tavily", "browserbase", "clickup"],
  echo: ["gohighlevel", "gws", "notion", "exa", "tavily", "browserbase"],
  flux: ["exa", "tavily", "browserbase", "gohighlevel", "gws", "square", "notion"],
  quill: ["exa", "tavily", "browserbase", "notion", "gws"],
  lex: ["exa", "tavily", "browserbase", "notion", "gws", "gohighlevel"],
  helia: ["gws", "exa", "tavily", "browserbase", "notion", "gohighlevel"],
  bridge: ["gws", "exa", "tavily", "browserbase", "notion", "gohighlevel", "zoom"],
  oracle: ["exa", "tavily", "browserbase", "notion", "gws", "firecrawl"],
  cipher: ["exa", "tavily", "browserbase", "gws", "notion", "firecrawl"],
  rift: ["exa", "tavily", "browserbase", "cloudflare", "gws", "notion", "playwright"],
  joule: ["exa", "tavily", "browserbase", "gohighlevel", "gws", "cloudflare", "notion", "zoom", "playwright", "clickup"],
  nexus: ["exa", "tavily", "browserbase", "notion", "gws", "gohighlevel"],
  aura: ["exa", "tavily", "browserbase", "notion", "gws"],
  zen: ["gws", "notion", "exa", "tavily", "browserbase", "gohighlevel", "clickup"],
  tesseract: ["exa", "tavily", "browserbase", "notion", "gws"],
};
