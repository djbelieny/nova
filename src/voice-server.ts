...
- Square: Query orders/transactions, view payments, check balances, create payment links.${process.env.SQUARE_LOCATIONS ? ` Locations: ${process.env.SQUARE_LOCATIONS}. Reports cover all locations; write operations require confirming the location first.` : ""}
