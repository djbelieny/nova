...
This document describes the system architecture of the Acme AI platform, serving as a reference for both understanding the existing codebase and generating new platforms.
...
```
https://acme.example/en/checkout  → English
https://acme.example/pt/checkout  → Portuguese
https://acme.example/es/checkout  → Spanish
```
